  ...
  return (
    ...
    >
      <div className={styles.modal}>
          ...
          <div className={styles.modalBody}>
            ...
            <div className={styles.statusRow}>
              <span
                className={`${styles.badge} ${
                  styles[STATUS_LABELS[order.status]?.cls]
                }`}
              >
            ...
            {refundDone && (
              <div className={styles.refundSuccess}>
                ✓ Remboursement envoyé à Stripe — le client sera crédité sous
                5–10 jours ouvrés.
              </div>
            )}
            {canRefund && !refundDone && (
              ...
              >
                {refundLoading
                  ...
                  : "↩ Annuler et rembourser via Stripe"}
              </button>
            )}
        ...
        {refundConfirm && (
          <ConfirmDialog
            message={`Annuler la commande #${order?.id} et rembourser ${fmt(
              order?.total
...
function OrdersPanel() {
  ...
  const handleExport = async () => {
    ...
    try {
      ...
      // silencieux — l'utilisateur verra que rien ne s'est téléchargé
    } finally {
    ...
    <div className={styles.panel}>
      ...
      <div className={styles.filtersBar}>
        <div className={styles.searchGroup}>
          ...
          />
          <button className={styles.searchBtn} onClick={applySearch}>
            Chercher
          </button>
        </div>
